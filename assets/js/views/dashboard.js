                ...
                return `
                 <div class="card project-card" style="position: relative; cursor: pointer; ${isClosed ? 'background: var(--bg-tertiary); opacity: 0.75;' : ''}" data-nav-id="${p.id}">
                     ...
                     <div style="display: flex; gap: 0.4rem; flex-wrap: wrap; align-items: center;">
                         ...
                         <span style="background: rgba(16, 185, 129, 0.1); color: #059669; border: 1px solid rgba(16, 185, 129, 0.2); padding: 2px 8px; border-radius: 12px; font-size: 0.72rem; font-weight: 600;">${item.isHourly ? '⏱️ 計時 ($750/h)' : '💼 固定分潤'}</span>
